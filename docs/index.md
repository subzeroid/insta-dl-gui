...
- **Live Queue** — per-job start and finish times, progress, byte counters and cancellation; completed jobs open the exact saved-file list with previews and system file actions
...
- **Profile relationships** — browse and search paginated Followers and Following lists for public profiles, then open any result directly in Explore
